...
Current structure represents a single project 
```
PROJECT_ROOT/
├── _buildr/            # Build system (Node.js)
...
Important!  templates should be versioned, universal and available to all website projects.
-- to be reorganized for multiple projects.
